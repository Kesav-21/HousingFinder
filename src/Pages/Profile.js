...
const onLogout=()=>{
  ...
  return (
    ...
    <div className='w-full md:w-[50%] mt-6 px-3'>
      <form>
        <input type="text" id="fname" value={fname} disabled  className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition ease-in-out mb-6' />
